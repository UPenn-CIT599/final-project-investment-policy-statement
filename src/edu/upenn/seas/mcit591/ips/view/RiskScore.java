...
public class RiskScore {
	...
	int numberofYears; // equal to number of years between expenditure year and now
	int Q1Score; // the score from user's answer in multiple choice of Q1
	int Q2Score; // the score from user's answer in multiple choice of Q2
	int Q3Score; // the score from user's answer in multiple choice of Q3
	int Q4Score; // the score from user's answer in multiple choice of Q4
	int Q5Score; // the score from user's answer in multiple choice of Q5
	int Q6Score; // the score from user's answer in multiple choice of Q6
	int Q7Score; // the score from user's length of investment time horizon


	int OverallRiskScore;
	String WillingRiskScore;
	String AbilityRiskScore;
	 ...
	 */
	public int getOverallRiskScore(int numberofYears) {
	 ...
	 */
	public String getWillingnessRiskScore() {
	...
	public String getAbilityRiskScore() {
