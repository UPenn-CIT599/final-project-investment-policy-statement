...
public class PortfolioAllocation {
		...
		// Method 1: calculate portfolio return

//		public static void getPortfolioReturn() {
//			
//			 //Creating  Arrays Representing Equations
//	        double[][] lhsArray = {{1166, 1126},
////	        , 0.0085, 0.0301, 0.0652, 
////	        						0.0265, 0.0351},
////	        						, 0.0348, 0.0459, 0.017, 0.1021, 0.0137},
//	        						{1,1}};
//	        double[] rhsArray = {70000,100};
...
//			
////			double PortfolioReturn = VTIreturn * VTIallocation + VOreturn * VOallocation + VBreturn * VBallocation
////					+ SHYreturn * SHYallocation + BNDreturn * BNDallocation + TLTreturn * TLTallocation
////					+ TIPreturn * TIPallocation + MUBreturn * MUBallocation + VEUreturn * VEUallocation
////					+ VSSreturn * VSSallocation + VWOreturn * VWOallocation + VNQreturn * VNQallocation
////					+ GLDreturn * GLDallocation;
////
...
//		};
		...
		public static double calcIRR(ArrayList<Integer> numbers) {
			double[] coeffic = {0.1166, 0.1126, 0.1132, 0.0085, 0.0301, 0.0652, 0.0265, 0.0351, 0.0348, 0.0459, 0.017, 0.1021, 0.0137};
			double sum = 0.0;
			for(int i=0; i<13; i++) {
				sum = sum+coeffic[i]*numbers.get(i);
			}
			return sum;	
		}
		...
		ArrayList<Integer> Arr = new ArrayList<Integer>();
			do {
				boolean test;
				do{
					ArrayList<Integer> ArrNumbers = new ArrayList<Integer>(randomNum());
					Arr = ArrNumbers;
					test = ArrNumbers.contains(0);
				}while(test==true);
			
			}while(calcIRR(Arr)<IRR);

			System.out.println(Arrays.deepToString(Arr.toArray()));
		}
		
		
		// Method 2: calculate portfolio standard deviation
...
//		Method 3: build a list to find the best asset allocation

//		List <Double> PortfolioAllocation = [13];
