...
//        label5.setForeground(Color.darkGray);
		...
		JLabel label6 = new JLabel("More risk usually means higher expected returns over the long term, "
				...
				+ "<br> We calculate the right balance for you based on:");
...
//        label11.setForeground(Color.darkGray);
		...
		JLabel label12 = new JLabel(
				"Ups and downs come standard in long-term investing, but not everyone is comfortable riding out the downturns. "
