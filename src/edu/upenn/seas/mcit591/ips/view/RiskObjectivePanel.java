...
public class RiskObjectivePanel extends JPanel {
	...
	public RiskObjectivePanel(){
        ...
        label1.setBorder(new EmptyBorder(50, 0, 20, 0));
        this.add(label1);
        
        int sum = getSum();
        System.out.println(sum);
        JLabel label2 = new JLabel("<html>Your overall risk score is <em>"+ DataManager.getRiskScore() +"</em> out of 10.</html>"); 
        label2.setFont(new Font("Georgia", Font.BOLD, 16));
        label2.setBorder(new EmptyBorder(50, 0, 20, 0));
        this.add(label2);
        
        JLabel label3 = new JLabel("<html>Your willingness to take risk is <em>"+DataManager.getWillingnessAssesment()+"</em>. Your ability to take risk is <em>"+ DataManager.getAbilityAssesment()+"</em>.</html>");
        label3.setFont(new Font("Georgia", Font.BOLD, 16));
        label3.setBorder(new EmptyBorder(50, 0, 20, 0));
        this.add(label3);
        
        if(DataManager.getWillingAndAbilityEquality() == true) {
        	JLabel label4 = new JLabel("<html><font color='red'>Your ability to take investment risk is not consistent with your willingness to take investment risk. We recomend you to balance these two options.</red></html>");
        ...
        label5.setBorder(new EmptyBorder(50, 0, 10, 0));
        ...
        label7.setFont(new Font("Georgia", Font.BOLD, 16));
        label7.setForeground(Color.darkGray);
        label7.setBorder(new EmptyBorder(50, 0, 10, 0));
        this.add(label7);
        ...
        label9.setFont(new Font("Georgia", Font.BOLD, 16));
        label9.setBorder(new EmptyBorder(50, 0, 10, 0));
        ...
        label10.setFont(new Font("Georgia", Font.PLAIN, 16));
        this.add(label10);
